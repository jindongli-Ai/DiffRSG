...
def start(conf, data, model, evaluate):
    ...
    max_hr_5, max_ndcg_5 = 0, 0
    max_hr_10, max_ndcg_10 = 0, 0
    max_hr_15, max_ndcg_15 = 0, 0
    ...
    for epoch in range(1, conf.epochs+1):
        ...
        # max_hr_5, max_ndcg_5 = max(max_hr_5, hr_5), max(max_ndcg_5, ndcg_5)
        # max_hr_10, max_ndcg_10 = max(max_hr_10, hr_10), max(max_ndcg_10, ndcg_10)
        # max_hr_15, max_ndcg_15 = max(max_hr_15, hr_15), max(max_ndcg_15, ndcg_15)
        ...
        #         max_ndcg_15 = ndcg_15
        #     else:
        #         max_ndcg_15 = max(max_ndcg_15, ndcg_15)   
        ...
        log.record('目前指标的最好结果: hr5:{:.4f}, hr10:{:.4f},  hr15:{:.4f}, ndcg5:{:.4f}, ndcg10:{:.4f}, ndcg15:{:.4f}'.format(max_hr_5,  max_hr_10, max_hr_15, max_ndcg_5,  max_ndcg_10, max_ndcg_15))
